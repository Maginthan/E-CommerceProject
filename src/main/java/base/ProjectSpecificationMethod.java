...
public class ProjectSpecificationMethod extends Utility{
	...
	public void reportInitialisation() {
		...
		sparkReporter = new ExtentSparkReporter("/Users/maginthangr/eclipse-workspace/E-CommerceProject/Reports/ExtentReport.html");
		extentReports.attachReporter(sparkReporter);
		sparkReporter.config().setReportName("Best buy test report");
